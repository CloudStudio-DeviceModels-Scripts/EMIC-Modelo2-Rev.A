...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // temperatura, mientras que el segundo es un sensor de CO2 y el tercero es 
  // una coordenada GPS.
    //Temperatura
    endpoints.addEndpoint("1", "Sensor de temperatura EMIC", endpointType.temperatureSensor);
    //CO2
    endpoints.addEndpoint("2", "Sensor PPM de CO2 EMIC", endpointType.ppmConcentrationSensor, ppmConcentrationSensorSubType.carbonDioxide);
    // GPS
    endpoints.addEndpoint("3", "GPS EMIC", endpointType.locationTracker);
}
